...
class __TwigTemplate_de00c856c45af4e964c3be354c483d0f600d25f52cf6bd72b1c942e71ee94c3b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50), 50, $this->source)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/olivero/templates/filter/filter-tips.html.twig", "/home/cabox/workspace/my-project/web/themes/olivero/templates/filter/filter-tips.html.twig");
    }
}
